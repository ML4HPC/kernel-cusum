//Differs from exp4 by kernel parameters
const char * prefix = "small_change_in_std_more_ref_exponent";
const float mu1 = 0;
...
double k(double x, double y, double alpha=0.3, double sigma2=2){
